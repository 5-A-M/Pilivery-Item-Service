package com.fiveam.searchservice.item.mapper;
...
import com.fiveam.searchservice.nutritionFact.dto.NutritionFactDto;
...
import com.fiveam.searchservice.review.mapper.ReviewMapper;
...
//        itemDetailResponseDto.setTalks(item.getTalks());
    ...
    default ItemDto.ItemDetailResponse itemToItemDetailResponseDto(Item item, ReviewService reviewService, ReviewMapper reviewMapper,
                                                                   TalkService talkService, UserServiceClient userService, TalkMapper talkMapper,
        ...
        itemDetailResponseDto.setReviews(new MultiResponseDto<>(reviewMapper.reviewsToReviewResponseDtos(reviews, userService), pageReview));

        Page<Talk> pageTalk = talkService.findItemTalks(item, talkPage, talkSize);
        List<Talk> talks = pageTalk.getContent();
        itemDetailResponseDto.setTalks(new MultiResponseDto<>(talkMapper.talksToTalkAndCommentDtos(talks, userService), pageTalk));
