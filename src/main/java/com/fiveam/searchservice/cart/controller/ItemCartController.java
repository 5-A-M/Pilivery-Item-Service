...
public class ItemCartController {
    ...
    @GetMapping("/{cartId}/itemcarts/{subscription}")
    public List<ItemCartInfoResponseDto> findItemCarts(@PathVariable Long cartId, @PathVariable Boolean subscription, boolean buyNow) {
